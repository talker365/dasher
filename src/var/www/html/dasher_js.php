<script type="text/javascript">
  const _config = JSON.parse('<?php
    ...
    if ( file_exists($filename) ) {
      ...
      echo '{"dreamCatcherAddress":"'.$_SERVER['SERVER_ADDR'].'","goesAddress":"'.$_SERVER['SERVER_ADDR'].'","gpsAddress":"'.$_SERVER['SERVER_ADDR'].'","echolinkAddress":"'.$_SERVER['SERVER_ADDR'].'","qthLatitude":"38","qthLongitude":"-78","qthAltitude":"1000","aprsZoom":"10"}';
    }
  ?>');
