...
<script type="text/javascript">
  ...
  function getJSON() { /*  */
    ...
    strUrl += "/bin/getData.php?feed=433&format=json&records=1000"
    //strUrl += "/getData.php?feed=433&format=json&records=1000"
...
<script type="text/javascript">
var objNavbar;
objNavbar = document.getElementById("navbar_weather");
